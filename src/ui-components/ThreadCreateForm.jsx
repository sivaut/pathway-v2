...
export default function ThreadCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const thread = await DataStore.save(new Thread(modelFieldsToSave));
          const promises = [];
          promises.push(
      ...
      {...getOverrideProps(overrides, "ThreadCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
