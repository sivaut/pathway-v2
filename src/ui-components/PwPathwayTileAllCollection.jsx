...
import PwPathwayTileAll from "./PwPathwayTileAll";
import { Collection } from "@aws-amplify/ui-react";
export default function PwPathwayTileAllCollection(props) {
  ...
  return (
    <Collection
      ...
      items={items || []}
      {...getOverrideProps(overrides, "PwPathwayTileAllCollection")}
      {...rest}
    >
      {(item, index) => (
        <PwPathwayTileAll
