...
export default function PwyIcons(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    { overrides: { PwyIcons: {} }, variantValues: { type: "warning" } },
    {
      overrides: {
        PwyIcons: {
          paths: [
    ...
    { overrides: { PwyIcons: {} }, variantValues: { type: "type21" } },
  ];
  ...
  return (
    <Icon
      ...
      {...getOverrideProps(overrides, "PwyIcons")}
      {...rest}
    ></Icon>
  );
}
