...
export default function PathwayCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setHasManyVersion(initialValues.hasManyVersion);
    setCurrentHasManyVersionValue(undefined);
    setCurrentHasManyVersionDisplayValue("");
    setLatestPathwayVersion(initialValues.latestPathwayVersion);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "PathwayCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
